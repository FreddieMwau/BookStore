...
booksRouter.post('/create', verify_1.verifyToken, bookControllers_1.createBook);
booksRouter.get('/', verify_1.verifyToken, bookControllers_1.getAllBooks);
booksRouter.get('/book/:bookId', verify_1.verifyToken, bookControllers_1.getBookById);
